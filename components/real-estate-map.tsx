...
export function RealEstateMapComponent() {
  ...
  useEffect(() => {
    ...
    cities.forEach((city) => {
      ...
      const color = new THREE.Color().setHSL(0.6 * (1 - normalizedPrice), 1, 0.5)
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="lg:w-1/3">
            <div className="bg-gray-800 p-4 rounded-lg mb-4">
              ...
              <p className="text-sm">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit animi accusamus iste excepturi dolor error natus culpa aspernatur iure quo. Animi facilis cumque officiis voluptate in sit nostrum dignissimos similique?
              </p>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg">
              ...
              <p className="text-sm font-bold text-green-400">+5.2% this month</p>
            </div>
          </div>
        </div>
      </div>
